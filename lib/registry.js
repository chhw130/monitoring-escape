...
import { SHOWROOM_BRANCHES, SHOWROOM_THEMES, fetchShowroomThemeSlots, fetchAllShowroomSlots } from './showroom'
...
const VENUES = [
  ...
  { branches: SHOWROOM_BRANCHES,   themes: SHOWROOM_THEMES,   fetchSlots: fetchShowroomThemeSlots,   fetchAll: fetchAllShowroomSlots },
]
