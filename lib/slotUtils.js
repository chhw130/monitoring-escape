 ...
 * openDaysAhead일 전 openHour시 openMinute분 KST에 예약 오픈
 */
export function isBookable(dateStr, openDaysAhead, openHour, openMinute = 0) {
  ...
  openTime.setUTCHours(openHour - 9, openMinute, 0, 0) // KST → UTC
